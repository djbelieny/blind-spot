    ...
    <main className="min-h-screen bg-[#08090F] px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          <button
            onClick={() => router.back()}
            className="text-[#8A8FA8]/50 text-sm hover:text-[#8A8FA8] transition-colors mb-8 block"
          >
            ← {isEn ? 'Back' : 'Voltar'}
          </button>
          {name && (
            <p className="text-[#8A8FA8] text-sm mb-1">
          ...
          {objective && (
            <p className="text-[#8A8FA8] text-sm mt-3 max-w-lg leading-relaxed">{objective}</p>
          )}
        </div>
              ...
              <div key={track.trackId} className="bg-[#0E0F1A] border border-[#8A8FA8]/10 rounded-3xl p-8">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    <p className="text-[#8A8FA8] text-xs mt-1">
                      {isEn
        ...
        {/* Study CTA */}
        <div className="mt-14 pt-10 border-t border-[#8A8FA8]/10 flex justify-between items-center">
          <p className="text-[#8A8FA8] text-sm">
